...
\begin{example}[The ``Is Born In'' Relation]  % TODO: Maybe change to "has lived in" for a better example of general relations
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=6cm]{images/part-0/relations/is-born-in.png}
    \end{figure}
