...
\begin{example}[The ``lived in'' Relation]
    ...
    On the left is the set of all mathematicians, and on the right is the set of all countries. The arrows shows how they are related. For example, the arrow from ``Peano'' points to ``Italy'' since Giuseppe Peano lived in Italy. Notice that Bertrand Russell did not live in any of the countries in $C$, and that no mathematician in $M$ lived in France.
\end{example}
