...
\begin{questions}
    ...
    % Proving $\leq$ is a Partial Order
    \item \begin{proof}
        ...
        \begin{itemize}
            ...
            \item \textbf{Antisymmetric}: Suppose $[(a,b)], [(c,d)] \in \Z$ such that $[(a,b)] \leq [(c,d)]$ and $[(c,d)] \leq [(a,b)]$. This means that 
            \[
            ...
            \item \textbf{Transitive}: Suppose $[(a,b)], [(c,d)], [(e,f)] \in \Z$ such that $[(a,b)] \leq [(c,d)]$ and $[(c,d)] \leq [(e,f)]$. Hence we have
            \[
