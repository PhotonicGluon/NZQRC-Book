...
\begin{example}[The ``lived in continent'' Relation]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[height=3.25cm]{images/part-1/relations-1/lived-in-continent_separate.png}
...
% TODO: Introduce composition associativity, and inverse of a composition