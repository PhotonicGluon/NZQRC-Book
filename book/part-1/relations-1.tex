...
\begin{definition}[Domain, Codomain, and Range (Relations)]
...
\begin{definition}[Composition of Relations]
    Let $A$, $B$, $C$, and $D$ be sets. Let $R$ and $S$ be relations from $A$ to $B$ and $C$ to $D$ respectively. The \term{composition of $R$ with $S$}\index{relation!composition}, written $S \circ R$, is a relation from $A$ to $D$ where
    \[
        a (\mathrel{S \circ R}) d \iff \exists x \in B \cap C \text{ s.t. } ((a \mathrel{R} x) \land (x \mathrel{S} d))
    \]
    for all $a \in A$ and $d \in D$. In other words,
    \[
        S \circ R = \{(a, d) \in A \times D \vert \exists x \in B \cap C \text{ s.t. } ((a, x) \in R \land (x, d) \in S)\}.
    \]
\end{definition}
...
\begin{theorem}[Shoes and Socks (Relations)]\label{theorem:shoes-and-socks-relations}\index{shoes and socks}
    Let $A$, $B$, $C$, and $D$ be sets, and let $R$ and $S$ be relations from $A$ to $B$ and $C$ to $D$ respectively. Then
    \[
...
\begin{theorem}[Associativity of Composition (Relations)]\index{relation!composition!associativity}\label{theorem:associativity-of-composition-relations}
    Let $A$, $B$, $C$, $D$, $E$, and $F$ be sets. Let $R$, $S$, and $T$ be relations from $A$ to $B$, $C$ to $D$, and $E$ to $F$ respectively. Then
    \[
        (T \circ S) \circ R = T \circ (S \circ R).
    \]
\end{theorem}
\begin{proof}
    First, note that if either $B \cap C$ or $D \cap E$ is empty, then $(T \circ S) \circ R = T \circ (S \circ R) = \emptyset$. So assume neither $B \cap C$ nor $D \cap E$ are empty.

    We note that $(T \circ S) \circ R \subseteq A \times F$ and $T \circ (S \circ R) \subseteq A \times F$. Now suppose $a \in A$ and $f \in F$. We see
    \begin{align*}
        &(a, f) \in (T \circ S) \circ R\\
        \iff& a \mathrel{((T \circ S) \circ R)} f\\
        \iff& \exists x \in B \cap C \text{ s.t. } (a \mathrel{R} x \land x \mathrel{(T\circ S)} f)\\
        \iff& \exists x \in B \cap C \text{ s.t. } (a \mathrel{R} x \land (\exists y \in D \cap E \text{ s.t. } (x \mathrel{S} y \land y \mathrel{T} f)))\\
        \iff& \exists x \in B \cap C, y \in D \cap E \text{ s.t. } (a \mathrel{R} x \land x \mathrel{S} y \land y \mathrel{T} f)\\
        \iff& \exists y \in D \cap E \text{ s.t. } ((\exists x \in B \cap C \text{ s.t. } (a \mathrel{R} x \land x \mathrel{S} y)) \land y \mathrel{T} f)\\
        \iff& \exists y \in D \cap E \text{ s.t. } (a \mathrel{(S \circ R)} y \land y \mathrel{T} f)\\
        \iff& a \mathrel{(T \circ (S \circ R))} f\\
        \iff& (a, f) \in T \circ (S \circ R).
    \end{align*}
