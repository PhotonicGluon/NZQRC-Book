...
\begin{wrapfigure}{r}{0.5\textwidth}
    \begin{center}
        \includegraphics[width=3cm]{images/part-1/relations-1/shoes-and-socks.jpg}
    \end{center}
\end{wrapfigure}

This observation that $(S\circ R)^{-1} = R^{-1} \circ S^{-1}$ is a key property of the inverse of a relation. This property is informally called the \term{shoes and socks property}\index{shoes and socks}.

% TODO: Continue

% TODO: Introduce composition associativity