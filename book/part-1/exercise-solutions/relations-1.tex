...
\begin{questions}
    ...
    \begin{align*}
        &(d, a) \in (S \circ R)^{-1}\\
        \iff& (a, d) \in S \circ R & (\text{Definition of inverse relation})\\
        \iff& \exists x \in B \cap C \text{ s.t. } (a \mathrel{R} x \land x \mathrel{S} d) & (\text{Definition of composition})\\
        \iff& \exists x \in B \cap C \text{ s.t. } (x \mathrel{R^{-1}} a \land d \mathrel{S^{-1}} x) & (\text{Definition of inverse relation})\\
        \iff& \exists x \in B \cap C \text{ s.t. } (d \mathrel{S^{-1}} x \land x \mathrel{R^{-1}} a) & (\text{Commutativity of } \land)\\
        \iff& (d, a) \in R^{-1} \circ S^{-1} & (\text{Definition of composition})
    \end{align*}
